(function($) {
    ...
    $.fn.share = function(options) {
        ...
        var open = function(url, w, h) {
            ...
            var win = window.open(url, "MsgWindow", 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=' + w + ', height=' + h + ', top=' + top + ', left=' + left)
            if(settings.onclose){
